  ...
  return (
    <div className="max-w-6xl mx-auto py-12 px-6">
      ...
      <div className="text-center mb-10">
        <h2 className="text-4xl font-bold text-gray-900">Contact our Boutique</h2>
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-12">
        <div className="flex items-center gap-4 bg-gray-100 p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-800 text-lg">+254 (758) 490-103</p>
        </div>
        <div className="flex items-center gap-4 bg-gray-100 p-6 rounded-lg shadow-md">
          <Mail className="w-8 h-8 text-orange-500" />
          <p className="text-gray-800 text-lg">info@boutique.com</p>
        </div>
        <div className="flex items-center gap-4 bg-gray-100 p-6 rounded-lg shadow-md">
